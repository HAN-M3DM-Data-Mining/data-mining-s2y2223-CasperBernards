...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  3 16:13:05 2023
...
from sklearn.metrics import ConfusionMatrixDisplay
    #1. Casper corrected the following: added from sklearn.metrics import ConfusionMatrixDisplay
...
cntDiag = rawDF['Outcome'].value_counts()
    #2. Casper corrected the following: RawDF['Outcome'] should be rawDF['Outcome']
...
rawDF[['Glucose', 'BloodPressure', 'Insulin', 'BMI']].describe()
    #3. Casper corrected the following: show() should be describe()
...
X = rawDF.loc[:, ~rawDF.columns.isin(excluded)]
    #4. Casper corrected the following: propDiag.columns.isin should be rawDF.columns.isin
...
knn.fit(X_train, y_train)
    #5. Casper corrected the following: Y_train should be y_train
